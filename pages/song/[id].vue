<template>
  <div>
    ...
    <span style="cursor: pointer;" @click="downloadAsTxt()">Экспорт txt</span>
  </div>
</template>
...
import { getTransposedText, exportAsText } from "~/utils/global";
...
function downloadAsTxt() {
  let textData = exportAsText(songData.value);
